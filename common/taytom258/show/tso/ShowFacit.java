...
public class ShowFacit extends Window {
	...
	private static void ccsd() {
		Window.getTextField_FacitCcsd().setText(
	...
	private static void tsoSubject() {
		Window.getTextField_FacitTsoSubject().setText(
