...
public class TSOCommit extends Database {
	...
	private static void circuit(){
		...
		String fields = "Full_CCSD, Trunk_ID, Full_TSP, TSP, To_Location, From_Location, Requesting_Department, Type_of_Service, "
				+ "Circuit_Use, Security, Data_Rate, Traffic_Flow, Term, Andrews_CMO, CMO, CMO_DSN, CMO_COMM, Signaling, "
				+ "Quality_Control_Code, EndPoint";
		String values = Collection.fullCcsd+c+Collection.trunkId+c+Collection.fullTsp+c+Collection.tsp+c+Collection.toLocation+c
		...
		sqlInsert("Circuits", fields, values);
	}
